...
function unsupportedPlatform(platform: string): GatewayError {
  return new GatewayError(
    `@interop-gateway/secrets's KeychainSecretsProvider has no OS keychain integration for platform "${platform}" (supported: darwin, linux) — use VaultSecretsProvider or AwsSecretsManagerProvider instead`,
